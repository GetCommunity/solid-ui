...
const PickerTrigger = <T extends ValidComponent = "button">(
  ...
  const props = rawProps as PickerTriggerProps
...
const PickerContent = <T extends ValidComponent = "div">(
  ...
  const local = props as PickerContentProps
...
const PickerLabel = <T extends ValidComponent = "span">(
  ...
  const local = props as PickerLabelProps
...
const PickerItem = <T extends ValidComponent = "div">(
  ...
  const props = merge({ variant: "default" as const }, rawProps) as PickerItemProps
  const others = omit(props, "class", "inset", "variant")
  return (
...
const PickerSubTrigger = <T extends ValidComponent = "div">(
  ...
  const local = props as PickerSubTriggerProps
  const others = omit(local, "class", "inset", "children")
  return (
...
const PickerSubContent = <T extends ValidComponent = "div">(
  ...
  const local = props as PickerSubContentProps
  const others = omit(local, "class")
  return (
...
const PickerRadioItem = <T extends ValidComponent = "div">(
  ...
  const local = props as PickerRadioItemProps
...
const PickerSeparator = <T extends ValidComponent = "hr">(
  ...
  const local = props as PickerSeparatorProps
  const others = omit(local, "class")
  return (
...
const PickerShortcut: Component<JSX.IntrinsicElements["span"]> = (props) => {
  const others = omit(props, "class")
  return (
    <span
      class={cn(
